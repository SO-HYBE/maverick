    ...
    <main className="relative" ref={elementsRef}>
      ...
      <div className="mx-1 h-screen flex justify-center items-center">
        <div className="hero-text z-10 mix-blend-difference flex flex-col items-center font-belanosima text-6xl text-white md:mt-8">
          ...
          <p className="main-p font-rubik mt-16 mx-8 md:leading-normal lg:mt-24 text-cyan-500">
      ...
      <Image className="-z-50 opacity-75" priority sizes="100%" src={"https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExbGc5b3F0Y2l5bnltcWp5NnI2aHhtZGc0c2J6NmQ2bmZnY3Z1Mmo1ayZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/Lh6F0BF0GCazK/giphy.webp"} alt={"hero section gif"} fill={true}></Image>
      {/* ------------------------ Hero Content ------------------------ */}
